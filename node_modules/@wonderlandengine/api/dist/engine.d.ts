...
export declare class WonderlandEngine {
     ...
     */
    loadMainScene(opts: LoadOptions & ActivateOptions, progress?: ProgressCallback): Promise<Scene>;
    /**
     ...
     */
    loadPrefab(opts: LoadOptions, progress?: ProgressCallback): Promise<Prefab>;
    /**
     ...
     */
    loadScene(opts: LoadOptions, progress?: ProgressCallback): Promise<Scene>;
    /**
